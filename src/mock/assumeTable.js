export default {
	"post|/api/teacherstudio/assume_practice_apply/get_table": () => {
		let arr = [
			{
		...
		return {
			...
			data: {
				...
				unit_title: "受理单位名称",
				reason:
					"申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由申请理由",
